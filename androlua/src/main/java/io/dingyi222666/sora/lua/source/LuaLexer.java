...
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.AND;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.ASSIGN;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.AT;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.BAD_CHARACTER;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.BIT_AND;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.BIT_LTLT;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.BIT_OR;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.BIT_RTRT;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.BIT_TILDE;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.BLOCK_COMMENT;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.BREAK;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.CASE;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.COLON;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.COMMA;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.CONCAT;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.CONTINUE;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.DEFAULT;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.DIV;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.DO;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.DOC_COMMENT;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.DOT;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.DOUBLE_COLON;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.DOUBLE_DIV;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.ELLIPSIS;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.ELSE;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.ELSEIF;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.END;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.ENDREGION;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.EQ;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.EXP;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.FALSE;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.FOR;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.FUNCTION;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.GE;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.GETN;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.GOTO;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.GT;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.IF;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.IN;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.LBRACK;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.LCURLY;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.LE;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.LEF;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.LOCAL;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.LONG_STRING;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.LPAREN;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.LT;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.MEAN;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.MINUS;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.MOD;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.MULT;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.NAME;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.NE;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.NEW_LINE;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.NIL;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.NOT;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.NUMBER;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.OR;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.PLUS;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.RBRACK;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.RCURLY;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.REGION;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.REPEAT;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.RETURN;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.RPAREN;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.SEMI;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.SHEBANG;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.SHEBANG_CONTENT;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.SHORT_COMMENT;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.STRING;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.SWITCH;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.THEN;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.TRUE;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.UNTIL;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.WHEN;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.WHILE;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.WHITE_SPACE;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.LAMBDA;
import static io.dingyi222666.sora.lua.source.LuaTokenTypes.DEFER;
